...
By applying this technique at each step, we integrate \eqref{eq:ode} with a
...
for finding the modified weights is a linear program.  Two important questions
arise:
\begin{itemize}
    \item How should the objective function be chosen?
    \item Does the resulting LP always have a solution?
\end{itemize}
