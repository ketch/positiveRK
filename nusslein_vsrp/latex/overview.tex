...
In this example the cost of computing the stage values is small. Additionally a small reduction of $\dt$ is enough to obtain positive results.  
If we compare the computation time we can see that using a smaller $\dt$ is faster than the adaption. 
Therefore solving the LP is no economical alternative to reducing the step size.}
