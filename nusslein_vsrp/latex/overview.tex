...
solution.  For the problem considered in the next section, where an implicit
integrator is used, it is more efficient to maintain positivity with our proposed
approach instead of reducing the step size.
Adaptation of the weights could be made even more efficient with
