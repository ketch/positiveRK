...
\begin{enumerate}[label=\arabic*.]
  ...
  \begin{enumerate}[label=\alph*)]
    ...
    equations [lines~{line:prod-dest}ff.].
    ...
    Thanks for noting this. We fixed the missing tilde in some figures (which
    were included in the original figure files but somehow were removed when
  ...
  \begin{enumerate}[label=\alph*)]
    ...
    \revA{TODO: See \url{https://github.com/ketch/Positive_RK_Reproducibility/pull/6}} %TODO
  ...
  \begin{enumerate}[label=\alph*)]
    ...
    \revA{TODO: Stephan wants to run some experiments} %TODO
